...
public class BSON {
    ...
    public static void Log(Object obj) {
        if (obj == null) {
            BSON.Log("Object is null.");
        } else {
            BSON.Log(obj.toString());
        }
    }

    public static void Log(String str) {
        System.out.println(BSON.CHAR_LEFT_MID + BSON.Long2Time(0) + BSON.CHAR_RIGHT_MID + "-Log: " + str);
    }

    public static void Warn(Object obj) {
        if (obj == null) {
            BSON.Warn("Object is null.");
        } else {
            BSON.Warn(obj.toString());
        }
    }

    public static void Warn(String str) {
        System.err.println(BSON.CHAR_LEFT_MID + BSON.Long2Time(0) + BSON.CHAR_RIGHT_MID + "-Warn: " + str);
    }
