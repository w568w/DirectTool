...
public class BmobE{
	...
	public static boolean initBmob(String appId, String restKey){
		return BmobE.initBmob(appId, restKey, 10000);
	}
	...
	public static BSONObject findAll(String tableName){
		return new BSONObject(BmobE.find(tableName,BSON.CHAR_NULL));
	}
	...
	public static BSONObject findAll(String tableName, BSONObject where){
		return BmobE.find(tableName, where, BSON.CHAR_NULL);
	}
	...
	public static BSONObject findOne(String tableName, String objectId){
		return BmobE.resultForBSONObject(Bmob.findOne(tableName, objectId));
	}
	...
	public static BSONObject find(String tableName, int limit){
		return BmobE.find(tableName, new BSONObject(), 0,limit, BSON.CHAR_NULL);
	}
	...
	public static BSONObject find(String tableName, BSONObject where, int limit){
		return BmobE.find(tableName, where, 0,limit, BSON.CHAR_NULL);
	}
	...
	public static BSONObject findColumns(String tableName, String keys, BSONObject where, int limit){
		return BmobE.findColumns(tableName, keys, where, 0,limit, BSON.CHAR_NULL);
	}
	...
	public static BSONObject find(String tableName, int skip, int limit){
		return BmobE.find(tableName, new BSONObject(), skip, limit, BSON.CHAR_NULL);
	}
	...
	public static BSONObject find(String tableName, BSONObject where, int skip, int limit){
		return BmobE.find(tableName, where, skip, limit, BSON.CHAR_NULL);
	}
	...
	public static BSONObject findColumns(String tableName, String keys, BSONObject where, int skip, int limit){
		return BmobE.findColumns(tableName, keys, where, skip, limit, BSON.CHAR_NULL);
	}
	...
	public static BSONObject find(String tableName, String order){
		return BmobE.find(tableName, new BSONObject(), 0, 1000, order);
	}
	...
	public static BSONObject find(String tableName, BSONObject where, String order){
		return BmobE.find(tableName, where, 0, 1000, order);
	}
	...
	public static BSONObject findColumns(String tableName, String keys, BSONObject where, String order){
		return BmobE.findColumns(tableName, keys, where, 0, 1000, order);
	}
	...
	public static BSONObject find(String tableName, int limit, String order){
		return BmobE.find(tableName, new BSONObject(), 0, limit, order);
	}
	...
	public static BSONObject find(String tableName, BSONObject where, int limit, String order){
		return BmobE.find(tableName, where, 0, limit, order);
	}
	...
	public static BSONObject findColumns(String tableName, String keys, BSONObject where, int limit, String order){
		return BmobE.findColumns(tableName, keys, where, 0, limit, order);
	}
	...
	public static BSONObject find(String tableName, BSONObject where, int skip, int limit, String order){
		return BmobE.findColumns(tableName, BSON.CHAR_NULL, where, skip, limit, order);
	}
	...
	public static BSONObject findColumns(String tableName, String keys, BSONObject where, int skip, int limit, String order){
		return BmobE.resultForBSONObject(Bmob.findColumns(tableName, keys, where.toString(), skip, limit, order));
	}
	...
	public static BSONObject findBQL(String BQL){
		return BmobE.findBQL(BQL, BSON.CHAR_NULL);
	}
	...
	public static BSONObject findBQL(String BQL, String value){
		return BmobE.resultForBSONObject(Bmob.findBQL(BQL, value));
	}
	...
	public static BSONObject getServerTime(){
		return BmobE.resultForBSONObject(Bmob.getServerTime());
	}
	...
	public static int count(String tableName){
		return BmobE.count(tableName, new BSONObject());
	}
	...
	public static BSONObject update(String tableName, String objectId, BSONObject paramContent){
		return BmobE.resultForBSONObject(Bmob.update(tableName, objectId, paramContent.toString()));
	}
	...
	public static BSONObject insert(String tableName, BSONObject paramContent){
		return BmobE.resultForBSONObject(Bmob.insert(tableName, paramContent.toString()));
	}
	...
	public static BSONObject delete(String tableName, String objectId){
		return BmobE.resultForBSONObject(Bmob.delete(tableName, objectId));
	}
	...
	public static BSONObject findPayOrder(String payId){
		return BmobE.resultForBSONObject(Bmob.findPayOrder(payId));
	}
	...
	public static BSONObject pushMsg(BSONObject data){
		return BmobE.resultForBSONObject(Bmob.pushMsg(data.toString()));
	}
	...
	public static BSONObject callFunction(String funcName, BSONObject paramContent){
		return BmobE.resultForBSONObject(Bmob.callFunction(funcName, paramContent.toString()));
	}
	...
	public static BSONObject login(String user, String passwd){
		return BmobE.resultForBSONObject(Bmob.login(user, passwd));
	}
	...
	public static BSONObject findAllTables(){
		return BmobE.resultForBSONObject(Bmob.findAllTables());
	}
	...
	public static BSONObject whereOr(BSONObject where1, BSONObject where2){
		return BmobE.whereForBSONObject(Bmob.whereOr(where1.toString(), where2.toString()));
	}
	...
	public static BSONObject whereAnd(BSONObject where1, BSONObject where2){
		return BmobE.whereForBSONObject(Bmob.whereAnd(where1.toString(), where2.toString()));
	}
	...
	public static BSONObject whereLess(int value){
		return BmobE.whereForBSONObject(Bmob.whereLess(value));
	}
	/**
	 * 操作符-小于
	...
	public static BSONObject whereLess(BSONObject value){
		return BmobE.whereForBSONObject(Bmob.whereLess(value.toString()));
	}
	...
	public static BSONObject whereLessEqual(int value){
		return BmobE.whereForBSONObject(Bmob.whereLessEqual(value));
	}
	/**
	 * 操作符-小于等于
	 * @param value 支持日期类型BSONObject
	...
	public static BSONObject whereLessEqual(BSONObject value){
		return BmobE.whereForBSONObject(Bmob.whereLessEqual(value.toString()));
	}
	...
	public static BSONObject whereGreate(int value){
		return BmobE.whereForBSONObject(Bmob.whereGreate(value));
	}
	/**
	 * 操作符-大于
	 * @param value 支持日期类型BSONObject
	...
	public static BSONObject whereGreate(BSONObject value){
		return BmobE.whereForBSONObject(Bmob.whereGreate(value.toString()));
	}
	...
	public static BSONObject whereGreateEqual(int value){
		return BmobE.whereForBSONObject(Bmob.whereGreateEqual(value));
	}
	/**
	 * 操作符-大于等于
	 * @param value 支持日期类型BSONObject
	...
	public static BSONObject whereGreateEqual(BSONObject value){
		return BmobE.whereForBSONObject(Bmob.whereGreateEqual(value.toString()));
	}
	...
	public static BSONObject whereNotEqual(int value){
		return BmobE.whereForBSONObject(Bmob.whereNotEqual(value));
	}
	/**
	 * 操作符-不等于
	 * @param value 支持日期类型BSONObject
	...
	public static BSONObject whereNotEqual(BSONObject value){
		return BmobE.whereForBSONObject(Bmob.whereNotEqual(value.toString()));
	}
	...
	public static BSONObject whereIn(int[] value){
		return BmobE.whereForBSONObject(Bmob.whereIn(value));
	}
	/**
	 * 操作符-包含
	...
	public static BSONObject whereNotIn(int[] value){
		return BmobE.whereForBSONObject(Bmob.whereNotIn(value));
	}
	/**
	 * 操作符-不包含
	 * @param value 目标数组值(例：new String[]{"张三","李四","王五"})
	...
	public static BSONObject whereExists(boolean value){
		return BmobE.whereForBSONObject(Bmob.whereExists(value));
	}
	...
	public static BSONObject whereAll(String value){
		return BmobE.whereForBSONObject(Bmob.whereAll(value));
	}
	...
	public static BSONObject whereIncluded(boolean greatEqual, int greatValue, boolean lessEqual, int lessValue){
		return BmobE.whereIncluded(greatEqual, String.valueOf(greatValue), lessEqual, String.valueOf(lessValue));
	}
	/**
	 * 操作符-区间包含
	 * @param greatEqual 是否大于包含等于
	...
	public static BSONObject whereIncluded(boolean greatEqual, String greatValue, boolean lessEqual, String lessValue){
		return BmobE.whereForBSONObject(Bmob.whereIncluded(greatEqual, greatValue, lessEqual, lessValue));
	}
	...
	public static BSONObject whereRegex(String regexValue){
		return BmobE.whereForBSONObject(Bmob.whereRegex(regexValue));
	}
	...
	public static BSONObject whereLike(String regexValue){
		return BmobE.whereForBSONObject(Bmob.whereLike(regexValue));
	}
